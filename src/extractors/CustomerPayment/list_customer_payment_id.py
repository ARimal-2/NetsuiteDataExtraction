...
from urls import CUSTOMER_PAYMENT_ID_URL
import urllib.parse
...
async def list_customer_payment_id():
    """Entry point to fetch all customers."""
    return await fetch_resource(CUSTOMER_PAYMENT_ID_URL, "list_customer_payment_id")

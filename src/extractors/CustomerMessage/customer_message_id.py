...
from urls import CUSTOMER_MESSAGE_ID_URL
import urllib.parse
...
async def list_customers_message_ids():
    """Entry point to fetch all message ids."""
    return await fetch_resource(CUSTOMER_MESSAGE_ID_URL, "list_customers_message_ids")

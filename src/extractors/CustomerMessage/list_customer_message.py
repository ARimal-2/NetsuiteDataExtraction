...
from urls import CUSTOMER_MESSAGE_LIST_URL
...
# -----------------------------
async def list_customer_message(message_ids):
    """Fetch all customers given the list of IDs"""
    return await fetch_resource(CUSTOMER_MESSAGE_LIST_URL, "list_customer_message", message_ids)
